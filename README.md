...
# Архитектура и Реверс инжениринг [Секво́йя] живет 5000 лет, Человек и Секвойя спроектированы из одного и тоже ДНК (Силлогизм сократ) 
...
# Архитектура [AirSim] & Реверс инжениринг & Team BlackSheep. 
![Image alt](http://www.people.com.cn/mediafile/pic/20171128/1/12939158227487160049.jpg)

[AirSim]- это симулятор для беспилотных летательных аппаратов, и искусственный интелект для Биржевых роботов
Наша цель - разработать AirSim в качестве платформы для исследований ИИ, чтобы экспериментировать с алгоритмами глубокого обучения, компьютерного зрения и усиления обучения для автономных транспортных средств. С этой целью AirSim также предоставляет API-интерфейсы для сбора данных и управления транспортными средствами независимо от платформы.

Архитектура [AirSim] & Реверс инжениринг 

https://drive.google.com/drive/folders/1CkKzbzmKV_d4ZL1MFP6NlUzTbpuLUqz7
